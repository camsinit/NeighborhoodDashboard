...
export default function createRouter<Config extends BaseConfig>(router: RouterFactory<Config>, procedure: ProcBuilder<Config>) {
    return router({
        ...
        createMany: procedure.input($Schema.EmergencyInfoInputSchema.createMany).mutation(async ({ ctx, input }) => checkMutate(db(ctx).emergencyInfo.createMany(input as any))),

        create: procedure.input($Schema.EmergencyInfoInputSchema.create).mutation(async ({ ctx, input }) => checkMutate(db(ctx).emergencyInfo.create(input as any))),

        deleteMany: procedure.input($Schema.EmergencyInfoInputSchema.deleteMany).mutation(async ({ ctx, input }) => checkMutate(db(ctx).emergencyInfo.deleteMany(input as any))),

        delete: procedure.input($Schema.EmergencyInfoInputSchema.delete).mutation(async ({ ctx, input }) => checkMutate(db(ctx).emergencyInfo.delete(input as any))),

        findFirst: procedure.input($Schema.EmergencyInfoInputSchema.findFirst).query(({ ctx, input }) => checkRead(db(ctx).emergencyInfo.findFirst(input as any))),

        findMany: procedure.input($Schema.EmergencyInfoInputSchema.findMany).query(({ ctx, input }) => checkRead(db(ctx).emergencyInfo.findMany(input as any))),

        findUnique: procedure.input($Schema.EmergencyInfoInputSchema.findUnique).query(({ ctx, input }) => checkRead(db(ctx).emergencyInfo.findUnique(input as any))),

        updateMany: procedure.input($Schema.EmergencyInfoInputSchema.updateMany).mutation(async ({ ctx, input }) => checkMutate(db(ctx).emergencyInfo.updateMany(input as any))),

        update: procedure.input($Schema.EmergencyInfoInputSchema.update).mutation(async ({ ctx, input }) => checkMutate(db(ctx).emergencyInfo.update(input as any))),
