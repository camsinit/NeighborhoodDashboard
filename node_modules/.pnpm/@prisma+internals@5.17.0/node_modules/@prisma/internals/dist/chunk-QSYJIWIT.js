...
var chunk_QSYJIWIT_exports = {};
__export2(chunk_QSYJIWIT_exports, {
...
module.exports = __toCommonJS2(chunk_QSYJIWIT_exports);
...
var import_chunk_4SMQAIG6 = require("./chunk-4SMQAIG6.js");
var import_chunk_2M6NEPUJ = require("./chunk-2M6NEPUJ.js");
var import_chunk_H34DHTRO = require("./chunk-H34DHTRO.js");
var import_chunk_U7ELKJX6 = require("./chunk-U7ELKJX6.js");
var import_chunk_YRBRUREX = require("./chunk-YRBRUREX.js");
var import_chunk_H3T4L34H = require("./chunk-H3T4L34H.js");
var import_chunk_W65Z4BE5 = require("./chunk-W65Z4BE5.js");
...
var import_chunk_SLGMG65I = require("./chunk-SLGMG65I.js");
...
var require_readdir_glob = (0, import_chunk_WWAWV7DQ.__commonJS)({
  "../../node_modules/.pnpm/readdir-glob@1.1.2/node_modules/readdir-glob/index.js"(exports2, module2) {
    ...
    var { Minimatch } = (0, import_chunk_SLGMG65I.require_minimatch)();
...
var require_stream_writable = (0, import_chunk_WWAWV7DQ.__commonJS)({
  "../../node_modules/.pnpm/readable-stream@2.3.7/node_modules/readable-stream/lib/_stream_writable.js"(exports2, module2) {
    ...
    util.inherits = (0, import_chunk_SLGMG65I.require_inherits)();
    var internalUtil = {
...
var require_stream_writable2 = (0, import_chunk_WWAWV7DQ.__commonJS)({
  "../../node_modules/.pnpm/readable-stream@3.6.0/node_modules/readable-stream/lib/_stream_writable.js"(exports2, module2) {
    ...
    (0, import_chunk_SLGMG65I.require_inherits)()(Writable, Stream);
    function nop() {
    }
...
var require_stream_duplex2 = (0, import_chunk_WWAWV7DQ.__commonJS)({
  "../../node_modules/.pnpm/readable-stream@3.6.0/node_modules/readable-stream/lib/_stream_duplex.js"(exports2, module2) {
    ...
    (0, import_chunk_SLGMG65I.require_inherits)()(Duplex, Readable);
    {
      keys = objectKeys(Writable.prototype);
      for (v = 0; v < keys.length; v++) {
        method = keys[v];
...
var require_stream_readable2 = (0, import_chunk_WWAWV7DQ.__commonJS)({
  "../../node_modules/.pnpm/readable-stream@3.6.0/node_modules/readable-stream/lib/_stream_readable.js"(exports2, module2) {
    ...
    var from;
    (0, import_chunk_SLGMG65I.require_inherits)()(Readable, Stream);
    var errorOrDestroy = destroyImpl.errorOrDestroy;
    var kProxyEvents = ["error", "close", "destroy", "pause", "resume"];
    function prependListener(emitter, event, fn) {
      if (typeof emitter.prependListener === "function") return emitter.prependListener(event, fn);
...
var require_stream_transform2 = (0, import_chunk_WWAWV7DQ.__commonJS)({
  "../../node_modules/.pnpm/readable-stream@3.6.0/node_modules/readable-stream/lib/_stream_transform.js"(exports2, module2) {
    ...
    (0, import_chunk_SLGMG65I.require_inherits)()(Transform, Duplex);
    function afterTransform(er, data) {
      var ts = this._transformState;
      ts.transforming = false;
      var cb = ts.writecb;
...
var require_stream_passthrough2 = (0, import_chunk_WWAWV7DQ.__commonJS)({
  "../../node_modules/.pnpm/readable-stream@3.6.0/node_modules/readable-stream/lib/_stream_passthrough.js"(exports2, module2) {
    ...
    (0, import_chunk_SLGMG65I.require_inherits)()(PassThrough, Transform);
    function PassThrough(options2) {
      if (!(this instanceof PassThrough)) return new PassThrough(options2);
      Transform.call(this, options2);
    }
...
var require_file = (0, import_chunk_WWAWV7DQ.__commonJS)({
  "../../node_modules/.pnpm/archiver-utils@4.0.1/node_modules/archiver-utils/file.js"(exports2, module2) {
    ...
    var glob = (0, import_chunk_SLGMG65I.require_glob)();
...
async function readSchemaFromDirectory(schemaPath2) {
  ...
  const config2 = await (0, import_chunk_H34DHTRO.getConfig)({
    datamodel: files,
...
async function getPrismaConfigFromPackageJson(cwd) {
  const pkgJson = await (0, import_chunk_SLGMG65I.readPackageUp)({ cwd, normalize: false });
...
async function checkUnsupportedDataProxyMessage(command, args, implicitSchema) {
  ...
  for (const [argName, argValue] of argList) {
    ...
    if (argName.includes("schema")) {
      ...
      const config2 = await (0, import_chunk_H34DHTRO.getConfig)({ datamodel, ignoreEnvVarErrors: true });
      const url = (0, import_chunk_H34DHTRO.resolveUrl)((0, import_chunk_H34DHTRO.getEffectiveUrl)(config2.datasources[0]));
...
var import_p_map = (0, import_chunk_WWAWV7DQ.__toESM)((0, import_chunk_SLGMG65I.require_p_map)());
...
async function getGenerators(options) {
  ...
  const config = await (0, import_chunk_H34DHTRO.getConfig)({
    datamodel: schemas,
  ...
  const dmmf = await (0, import_chunk_U7ELKJX6.getDMMF)({
    datamodel: schemas,
    datamodelPath: schemaPath,
    prismaPath,
    previewFeatures
...
The generator needs to either define the \`defaultOutput\` path in the manifest or you need to define \`output\` in the datamodel.prisma file.`
        ...
        const datamodel = (0, import_chunk_2M6NEPUJ.mergeSchemas)({ schemas });
    ...
    for (const generator of generators) {
      if (generator.manifest && generator.manifest.requiresEngines) {
        ...
        if (engineVersion !== version && generator.options && generator.manifest.requiresEngines.includes(queryEngineType) && generatorBinaryPaths[queryEngineType] && generatorBinaryPaths[queryEngineType]?.[binaryTarget]) {
          const customDmmf = await (0, import_chunk_U7ELKJX6.getDMMF)({
            datamodel: schemas,
            datamodelPath: schemaPath,
...
async function formatSchema({ schemas: schemas2 }, inputFormattingOptions) {
  if (process.env.FORCE_PANIC_PRISMA_SCHEMA) {
    handleFormatPanic(
      () => {
        import_chunk_W65Z4BE5.prismaSchemaWasm.debug_panic();
      },
      { schemas: schemas2 }
    );
  }
  ...
  const { formattedMultipleSchemas, lintDiagnostics } = handleFormatPanic(
    () => {
      ...
      const lintDiagnostics2 = (0, import_chunk_4SMQAIG6.lintSchema)({ schemas: formattedMultipleSchemas2 });
      return { formattedMultipleSchemas: formattedMultipleSchemas2, lintDiagnostics: lintDiagnostics2 };
    },
    { schemas: schemas2 }
  );
  const lintWarnings = (0, import_chunk_4SMQAIG6.getLintWarningsAsText)(lintDiagnostics);
...
function formatWasm(schema, documentFormattingParams) {
  const formattedSchema = import_chunk_W65Z4BE5.prismaSchemaWasm.format(schema, JSON.stringify(documentFormattingParams));
