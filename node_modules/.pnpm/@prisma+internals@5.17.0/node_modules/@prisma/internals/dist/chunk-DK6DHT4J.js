...
var chunk_DK6DHT4J_exports = {};
__export(chunk_DK6DHT4J_exports, {
  ValidateError: () => ValidateError,
  validate: () => validate
});
module.exports = __toCommonJS(chunk_DK6DHT4J_exports);
...
function validate(options) {
  const debugErrorType = (0, import_chunk_KUMD5MBR.createDebugErrorType)(debug, "validateWasm");
  ...
  const validateEither = (0, import_function.pipe)(
    (0, import_chunk_4A5ZK522.tryCatch)(
      () => {
        ...
        import_chunk_USCCELUI.prismaSchemaWasm.validate(params);
      },
      (e) => ({
        type: "wasm-error",
  ...
  if ((0, import_chunk_4A5ZK522.isRight)(validateEither)) {
    return;
  }
  const error = (0, import_chunk_H3T4L34H.$)(validateEither.left).with({ type: "wasm-error" }, (e) => {
    ...
    return new ValidateError((0, import_chunk_KUMD5MBR.parseQueryEngineError)({ errorOutput, reason: e.reason }));
  }).exhaustive();
  throw error;
}
