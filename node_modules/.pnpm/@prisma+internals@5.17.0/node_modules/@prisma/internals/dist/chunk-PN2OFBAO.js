...
var chunk_PN2OFBAO_exports = {};
__export(chunk_PN2OFBAO_exports, {
...
module.exports = __toCommonJS(chunk_PN2OFBAO_exports);
...
async function execaCommand({
  ...
  schemaEnginePath = schemaEnginePath || await (0, import_chunk_GHYJGM56.resolveBinary)(import_fetch_engine.BinaryType.SchemaEngineBinary);
  try {
