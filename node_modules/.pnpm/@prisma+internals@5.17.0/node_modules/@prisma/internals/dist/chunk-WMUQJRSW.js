...
var chunk_WMUQJRSW_exports = {};
__export2(chunk_WMUQJRSW_exports, {
...
module.exports = __toCommonJS2(chunk_WMUQJRSW_exports);
...
var import_chunk_D5RDZNDT = require("./chunk-D5RDZNDT.js");
var import_chunk_7Q7CW433 = require("./chunk-7Q7CW433.js");
var import_chunk_ML5DM6H7 = require("./chunk-ML5DM6H7.js");
var import_chunk_MFESV73I = require("./chunk-MFESV73I.js");
var import_chunk_YRBRUREX = require("./chunk-YRBRUREX.js");
var import_chunk_H3T4L34H = require("./chunk-H3T4L34H.js");
var import_chunk_USCCELUI = require("./chunk-USCCELUI.js");
...
async function readSchemaFromDirectory(schemaPath2) {
  ...
  const config2 = await (0, import_chunk_ML5DM6H7.getConfig)({
    datamodel: files,
...
async function checkUnsupportedDataProxyMessage(command, args, implicitSchema) {
  ...
  for (const [argName, argValue] of argList) {
    ...
    if (argName.includes("schema")) {
      ...
      const config2 = await (0, import_chunk_ML5DM6H7.getConfig)({ datamodel, ignoreEnvVarErrors: true });
      const url = (0, import_chunk_ML5DM6H7.resolveUrl)((0, import_chunk_ML5DM6H7.getEffectiveUrl)(config2.datasources[0]));
...
async function getGenerators(options) {
  ...
  const config = await (0, import_chunk_ML5DM6H7.getConfig)({
    datamodel: schemas,
  ...
  const dmmf = await (0, import_chunk_MFESV73I.getDMMF)({
    datamodel: schemas,
    datamodelPath: schemaPath,
    prismaPath,
    previewFeatures
...
The generator needs to either define the \`defaultOutput\` path in the manifest or you need to define \`output\` in the datamodel.prisma file.`
        ...
        const datamodel = (0, import_chunk_7Q7CW433.mergeSchemas)({ schemas });
    ...
    for (const generator of generators) {
      if (generator.manifest && generator.manifest.requiresEngines) {
        ...
        if (engineVersion !== version && generator.options && generator.manifest.requiresEngines.includes(queryEngineType) && generatorBinaryPaths[queryEngineType] && generatorBinaryPaths[queryEngineType]?.[binaryTarget]) {
          const customDmmf = await (0, import_chunk_MFESV73I.getDMMF)({
            datamodel: schemas,
            datamodelPath: schemaPath,
...
async function formatSchema({ schemas: schemas2 }, inputFormattingOptions) {
  if (process.env.FORCE_PANIC_PRISMA_SCHEMA) {
    handleFormatPanic(
      () => {
        import_chunk_USCCELUI.prismaSchemaWasm.debug_panic();
      },
      { schemas: schemas2 }
    );
  }
  ...
  const { formattedMultipleSchemas, lintDiagnostics } = handleFormatPanic(
    () => {
      ...
      const lintDiagnostics2 = (0, import_chunk_D5RDZNDT.lintSchema)({ schemas: formattedMultipleSchemas2 });
      return { formattedMultipleSchemas: formattedMultipleSchemas2, lintDiagnostics: lintDiagnostics2 };
    },
    { schemas: schemas2 }
  );
  const lintWarnings = (0, import_chunk_D5RDZNDT.getLintWarningsAsText)(lintDiagnostics);
...
function formatWasm(schema, documentFormattingParams) {
  const formattedSchema = import_chunk_USCCELUI.prismaSchemaWasm.format(schema, JSON.stringify(documentFormattingParams));
