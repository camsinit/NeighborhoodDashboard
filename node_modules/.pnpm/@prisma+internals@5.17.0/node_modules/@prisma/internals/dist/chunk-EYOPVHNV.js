...
var chunk_EYOPVHNV_exports = {};
__export(chunk_EYOPVHNV_exports, {
  getEnginesInfo: () => getEnginesInfo,
  getEnginesMetaInfo: () => getEnginesMetaInfo,
  resolveEngine: () => resolveEngine
});
module.exports = __toCommonJS(chunk_EYOPVHNV_exports);
var import_chunk_QOTVZEEZ = require("./chunk-QOTVZEEZ.js");
var import_chunk_QL3K6JIN = require("./chunk-QL3K6JIN.js");
var import_chunk_H3T4L34H = require("./chunk-H3T4L34H.js");
var import_chunk_GHYJGM56 = require("./chunk-GHYJGM56.js");
var import_chunk_4A5ZK522 = require("./chunk-4A5ZK522.js");
var import_chunk_WWAWV7DQ = require("./chunk-WWAWV7DQ.js");
var import_engines = require("@prisma/engines");
var import_fetch_engine = require("@prisma/fetch-engine");
var import_path = __toESM(require("path"));
var import_function2 = (0, import_chunk_WWAWV7DQ.__toESM)((0, import_chunk_QOTVZEEZ.require_function)());
var none2 = import_chunk_4A5ZK522.none;
var some2 = import_chunk_4A5ZK522.some;
var getRight = function(ma) {
  return ma._tag === "Left" ? none2 : some2(ma.right);
};
var _map = function(fa, f) {
  return (0, import_chunk_4A5ZK522.pipe)(fa, map(f));
};
var _ap = function(fab, fa) {
  return (0, import_chunk_4A5ZK522.pipe)(fab, ap(fa));
};
var URI = "Option";
var map = function(f) {
  return function(fa) {
...
var as2 = (0, import_chunk_4A5ZK522.dual)(2, (0, import_chunk_4A5ZK522.as)(Functor));
var asUnit2 = (0, import_chunk_4A5ZK522.asUnit)(Functor);
var ap = function(fa) {
  return function(fab) {
    return isNone(fab) ? none2 : isNone(fa) ? none2 : some2(fab.value(fa.value));
  };
};
var flatMap = /* @__PURE__ */ (0, import_chunk_4A5ZK522.dual)(2, function(ma, f) {
...
var orElse = (0, import_chunk_4A5ZK522.dual)(2, function(self, that) {
...
var isSome2 = import_chunk_4A5ZK522.isSome;
...
var match = matchW;
var fold = match;
var tap2 = /* @__PURE__ */ (0, import_chunk_4A5ZK522.dual)(2, (0, import_chunk_4A5ZK522.tap)(Chain));
var tapEither2 = /* @__PURE__ */ (0, import_chunk_4A5ZK522.dual)(2, (0, import_chunk_4A5ZK522.tapEither)(FromEither, Chain));
...
function getEnginesInfo(enginesInfo) {
  ...
  const absolutePath = (0, import_chunk_H3T4L34H.$)(enginesInfo).with({ path: import_chunk_H3T4L34H.N.when(import_chunk_4A5ZK522.isRight) }, (_engineInfo) => {
    return _engineInfo.path.right;
  }).with({ path: import_chunk_H3T4L34H.N.when(import_chunk_4A5ZK522.isLeft) }, (_engineInfo) => {
    errors.push(_engineInfo.path.left);
    return "E_CANNOT_RESOLVE_PATH";
  }).exhaustive();
  const version = (0, import_chunk_H3T4L34H.$)(enginesInfo).with({ version: import_chunk_H3T4L34H.N.when(import_chunk_4A5ZK522.isRight) }, (_engineInfo) => {
    return _engineInfo.version.right;
  }).with({ version: import_chunk_H3T4L34H.N.when(import_chunk_4A5ZK522.isLeft) }, (_engineInfo) => {
...
async function resolveEngine(binaryName) {
  ...
  const enginePathEither = await (0, import_function2.pipe)(
    pathFromEnvOption,
    fold(
      () => (0, import_chunk_GHYJGM56.safeResolveBinary)(binaryName),
      (pathFromEnv) => (0, import_chunk_4A5ZK522.right2)(pathFromEnv.path)
    )
  )();
  const versionEither = await (0, import_function2.pipe)(
    enginePathEither,
    import_chunk_4A5ZK522.fromEither,
    (0, import_chunk_4A5ZK522.chain)((enginePath) => {
      return (0, import_chunk_QL3K6JIN.safeGetEngineVersion)(enginePath, binaryName);
    })
  )();
  const engineInfo = {
