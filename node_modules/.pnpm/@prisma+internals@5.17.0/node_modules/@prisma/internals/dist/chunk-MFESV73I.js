...
var chunk_MFESV73I_exports = {};
__export(chunk_MFESV73I_exports, {
  GetDmmfError: () => GetDmmfError,
  getDMMF: () => getDMMF
});
module.exports = __toCommonJS(chunk_MFESV73I_exports);
...
async function getDMMF(options) {
  ...
  const debugErrorType = (0, import_chunk_KUMD5MBR.createDebugErrorType)(debug, "getDmmfWasm");
  debug(`Using getDmmf Wasm`);
  const dmmfPipeline = (0, import_function.pipe)(
    (0, import_chunk_4A5ZK522.tryCatch2)(
      () => {
    ...
    (0, import_chunk_4A5ZK522.chainW2)((datamodel) => {
      return (0, import_function.pipe)(
        (0, import_chunk_4A5ZK522.tryCatch)(
          () => {
            ...
            const data = import_chunk_USCCELUI.prismaSchemaWasm.get_dmmf(params);
            return data;
          },
          (e) => ({
            type: "wasm-error",
  ...
  if ((0, import_chunk_4A5ZK522.isRight)(dmmfEither)) {
...
Datamodel path: "${e.datamodelPath}"`,
    ...
    return new GetDmmfError((0, import_chunk_KUMD5MBR.parseQueryEngineError)({ errorOutput, reason: e.reason }));
