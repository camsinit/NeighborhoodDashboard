 ...
 * @returns useQuery hook
 */
declare function useInfiniteModelQuery<TQueryFnData, TData, TError>(model: string, url: string, args?: unknown, options?: Omit<CreateInfiniteQueryOptions<TQueryFnData, TError, TData>, 'queryKey'>, fetch?: FetchFn): _tanstack_svelte_query.CreateInfiniteQueryResult<TData, TError>;
/**
