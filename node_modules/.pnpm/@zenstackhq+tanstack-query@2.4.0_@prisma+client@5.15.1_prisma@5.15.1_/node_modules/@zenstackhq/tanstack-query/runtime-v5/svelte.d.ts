 ...
 */
declare function useModelQuery<TQueryFnData, TData, TError>(model: string, url: string, args?: unknown, options?: StoreOrVal<Omit<CreateQueryOptions<TQueryFnData, TError, TData>, 'queryKey'>> & ExtraQueryOptions, fetch?: FetchFn): _tanstack_svelte_query_v5.CreateQueryResult<TData, TError>;
/**
 ...
 * @returns useQuery hook
 */
declare function useInfiniteModelQuery<TQueryFnData, TData, TError>(model: string, url: string, args: unknown, options: StoreOrVal<Omit<CreateInfiniteQueryOptions<TQueryFnData, TError, InfiniteData<TData>>, 'queryKey' | 'initialPageParam'>>, fetch?: FetchFn): _tanstack_svelte_query_v5.CreateInfiniteQueryResult<InfiniteData<TData, unknown>, TError>;
/**
