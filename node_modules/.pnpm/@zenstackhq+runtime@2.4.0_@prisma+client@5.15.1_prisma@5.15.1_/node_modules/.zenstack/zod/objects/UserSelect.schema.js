...
exports.UserSelectObjectSchema = zod_1.z.object({
    id: zod_1.z.boolean().optional(), name: zod_1.z.boolean().optional(), email: zod_1.z.boolean().optional(), pictureUrl: zod_1.z.boolean().optional(), stripeCustomerId: zod_1.z.boolean().optional(), password: zod_1.z.boolean().optional(), dateCreated: zod_1.z.boolean().optional(), dateUpdated: zod_1.z.boolean().optional(), accounts: zod_1.z.union([zod_1.z.boolean(),
