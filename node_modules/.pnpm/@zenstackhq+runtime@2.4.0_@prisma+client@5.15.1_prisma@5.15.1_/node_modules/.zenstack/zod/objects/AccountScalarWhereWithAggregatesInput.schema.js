...
exports.AccountScalarWhereWithAggregatesInputObjectSchema = zod_1.z.object({
    AND: zod_1.z.union([zod_1.z.lazy(() => exports.AccountScalarWhereWithAggregatesInputObjectSchema),
        ...
        zod_1.z.string(),
        zod_1.z.null()]).optional().nullable(), refresh_token_expires_in: zod_1.z.union([zod_1.z.lazy(() => IntNullableWithAggregatesFilter_schema_1.IntNullableWithAggregatesFilterObjectSchema),
        zod_1.z.number(),
