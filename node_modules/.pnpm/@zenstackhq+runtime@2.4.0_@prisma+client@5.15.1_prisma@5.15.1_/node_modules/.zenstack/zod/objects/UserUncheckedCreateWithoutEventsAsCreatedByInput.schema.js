...
exports.UserUncheckedCreateWithoutEventsAsCreatedByInputObjectSchema = void 0;
/* eslint-disable */
...
const OfferingUncheckedCreateNestedManyWithoutCreatedByInput_schema_1 = require("./OfferingUncheckedCreateNestedManyWithoutCreatedByInput.schema");
...
exports.UserUncheckedCreateWithoutEventsAsCreatedByInputObjectSchema = zod_1.z.object({
    id: zod_1.z.string().optional(), name: zod_1.z.union([zod_1.z.string(),
        ...
        zod_1.z.null()]).optional().nullable(), dateCreated: zod_1.z.union([zod_1.z.date().optional(), zod_1.z.string().datetime().optional()]), dateUpdated: zod_1.z.union([zod_1.z.date().optional(), zod_1.z.string().datetime().optional()]), accounts: zod_1.z.lazy(() => AccountUncheckedCreateNestedManyWithoutUserInput_schema_1.AccountUncheckedCreateNestedManyWithoutUserInputObjectSchema).optional(), sessions: zod_1.z.lazy(() => SessionUncheckedCreateNestedManyWithoutUserInput_schema_1.SessionUncheckedCreateNestedManyWithoutUserInputObjectSchema).optional(), roles: zod_1.z.lazy(() => RoleUncheckedCreateNestedManyWithoutUserInput_schema_1.RoleUncheckedCreateNestedManyWithoutUserInputObjectSchema).optional(), groupsAsCreatedBy: zod_1.z.lazy(() => GroupUncheckedCreateNestedManyWithoutCreatedByInput_schema_1.GroupUncheckedCreateNestedManyWithoutCreatedByInputObjectSchema).optional(), offeringsAsCreatedBy: zod_1.z.lazy(() => OfferingUncheckedCreateNestedManyWithoutCreatedByInput_schema_1.OfferingUncheckedCreateNestedManyWithoutCreatedByInputObjectSchema).optional(), emergencyInfos: zod_1.z.lazy(() => EmergencyInfoUncheckedCreateNestedManyWithoutUserInput_schema_1.EmergencyInfoUncheckedCreateNestedManyWithoutUserInputObjectSchema).optional(), needWants: zod_1.z.lazy(() => NeedWantUncheckedCreateNestedManyWithoutUserInput_schema_1.NeedWantUncheckedCreateNestedManyWithoutUserInputObjectSchema).optional(), interests: zod_1.z.lazy(() => InterestUncheckedCreateNestedManyWithoutUserInput_schema_1.InterestUncheckedCreateNestedManyWithoutUserInputObjectSchema).optional(), responses: zod_1.z.lazy(() => ResponseUncheckedCreateNestedManyWithoutUserInput_schema_1.ResponseUncheckedCreateNestedManyWithoutUserInputObjectSchema).optional()
}).strict();
