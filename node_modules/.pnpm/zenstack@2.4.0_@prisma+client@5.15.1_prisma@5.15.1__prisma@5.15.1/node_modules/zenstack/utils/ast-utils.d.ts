 ...
 */
export declare function getAllLoadedDataModels(langiumDocuments: LangiumDocuments): DataModel[];
/**
 * Gets all data models from loaded and reachable documents
 */
export declare function getAllLoadedAndReachableDataModels(langiumDocuments: LangiumDocuments, fromModel?: DataModel): DataModel[];
/**
