...
class PluginRunner {
    ...
    run(runnerOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (const { name, description, run, options: pluginOptions } of corePlugins) {
                ...
                const r = yield this.runPlugin(name, description, run, runnerOptions, options, dmmf, shortNameMap, project);
    ...
    runPlugin(name, description, run, runnerOptions, options, dmmf, shortNameMap, project) {
        return __awaiter(this, void 0, void 0, function* () {
