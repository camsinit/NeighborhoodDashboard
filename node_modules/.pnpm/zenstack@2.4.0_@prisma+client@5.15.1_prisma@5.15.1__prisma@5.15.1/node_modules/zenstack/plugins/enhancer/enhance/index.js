...
class EnhancerGenerator {
    constructor(model, options, project, outDir) {
        ...
        this.outDir = outDir;
        this.ModelCreateUpdateInputRegex = /(\S+)(Unchecked)?(Create|Update).*Input/;
    ...
    generate() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const enhanceTs = this.project.createSourceFile(path_1.default.join(this.outDir, 'enhance.ts'), `/* eslint-disable */
...
`;
    ...
    removeDiscriminatorFromConcreteInput(typeAlias, _delegateInfo, source) {
