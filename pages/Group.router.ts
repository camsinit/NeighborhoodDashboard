...
export default function createRouter<Config extends BaseConfig>(router: RouterFactory<Config>, procedure: ProcBuilder<Config>) {
    return router({
        ...
        createMany: procedure.input($Schema.GroupInputSchema.createMany).mutation(async ({ ctx, input }) => checkMutate(db(ctx).group.createMany(input as any))),
        ...
        deleteMany: procedure.input($Schema.GroupInputSchema.deleteMany).mutation(async ({ ctx, input }) => checkMutate(db(ctx).group.deleteMany(input as any))),
        ...
        findFirst: procedure.input($Schema.GroupInputSchema.findFirst).query(({ ctx, input }) => checkRead(db(ctx).group.findFirst(input as any))),

        findMany: procedure.input($Schema.GroupInputSchema.findMany).query(({ ctx, input }) => checkRead(db(ctx).group.findMany(input as any))),
